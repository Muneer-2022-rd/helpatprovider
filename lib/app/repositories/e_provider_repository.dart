...
class EProviderRepository {
  ...
  Future<List<EService>> getEServices({required int page}) {
  ...
  Future<List<EService>?> getPopularEServices({required int page}) {
    return _laravelApiClient.getEProviderPopularEServices(page);
  }

  Future<List<EService>> getMostRatedEServices({required int page}) {
    return _laravelApiClient.getEProviderMostRatedEServices(page);
  }

  Future<List<EService>> getAvailableEServices({required int page}) {
    return _laravelApiClient.getEProviderAvailableEServices(page);
  }

  Future<List<EService>> getFeaturedEServices({required int page}) {

...
class ProfileView extends GetView<ProfileController> {
  ...
  Widget build(BuildContext context) {
    print("Password User : ${Get.find<AuthService>().user.value.password}");
        ...
        bottomNavigationBar: Container(
          ...
          child: Row(
            children: [
              ...
              MaterialButton(
                onPressed: () {
                  controller.openSweetSheet(context);
                },
                padding: EdgeInsets.symmetric(horizontal: 30, vertical: 12),
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(10)),
                ...
                child:
                    Text("Delete Profile".tr, style: Get.textTheme.bodyText2),
                elevation: 0,
            ...
            children: [
              ...
              Obx(() {
                ...
                return TextFieldWidget(
                  ...
                  validator: (input) =>
                  input != Get.find<AuthService>().user.value.password &&
                      input!.isNotEmpty
              ...
              Obx(() {
                return TextFieldWidget(
                  ...
                  validator: (input) {
                    ...
                    } else if (controller.oldPassword.isNotEmpty && input.isEmpty) {

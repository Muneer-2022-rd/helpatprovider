                ...
                child: Column(
                  ...
                  children: [
                    Text(DateFormat('HH:mm', Get.locale.toString()).format(_booking.value!.bookingAt!),
                        ...
                        overflow: TextOverflow.fade),
                    Text(DateFormat('dd', Get.locale.toString()).format(_booking.value!.bookingAt ?? '' as DateTime),
                        maxLines: 1,
                        ...
                        textAlign: TextAlign.center,
                        overflow: TextOverflow.fade),
                    Text(DateFormat('MMM', Get.locale.toString()).format(_booking.value!.bookingAt ?? '' as DateTime),
                        maxLines: 1,
                        style: Get.textTheme.bodyText2!.merge(
                          TextStyle(color: Get.theme.colorScheme.secondary, height: 1),
                        ),

            ...
            children: [
              Expanded(
                child: MaterialButton(
                  ...
                  child: Text(controller.isCreateForm() ? "Add Service".tr : "Update Service",
...
//                  ),
                ...
                Obx(() {
                  Get.log(controller.eProviders.length.toString());
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          MaterialButton(
                            onPressed: () async {
                              controller.showTimeInputPicker(context);
                            },
                            shape: StadiumBorder(),
                            color: Get.theme.colorScheme.secondary
                                .withOpacity(0.1),
                      ...
                      GetBuilder<EServiceFormController>(builder: (controller) {
                        if (controller.eService.value!.duration == null) {
                          return Padding(
                            padding: EdgeInsets.symmetric(vertical: 20),
                            child: Text(
                              "Select Duration".tr,
                          ...
                          return Padding(
                            padding: EdgeInsets.symmetric(vertical: 20),
                            child: Text(
                              controller.eService.value!.duration!,
                              style: Get.textTheme.caption!
                      ...
                      Obx(() {
                        return ListTileTheme(
                          ...
                          child: ListBody(
                            children: [
                              CheckboxListTile(
                                value: controller.eService.value!.featured ??
                                    false,
                                selected: controller.eService.value!.featured ??
                                    false,
